...
namespace ProyectoTwentys
{
    ...
    {
        PB_GastosVarios objeto = new PB_GastosVarios();
        private bool Editar = false;
        string idGastosVarios = null;
        ...
        private void GastosVarios_Load(object sender, EventArgs e)
        {
            Mostrar();
        ...
        {
            PB_GastosVarios objetoMostrar = new PB_GastosVarios();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (Editar == true)
            {
                ...
                try
                {
                    ...
                    {
                        objeto.Actualizar(idGastosVarios, txtDescripcion.Text, txtFecha.Value, txtMonto.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (tabla.SelectedRows.Count > 0)
            {
                ...
                idGastosVarios = tabla.CurrentRow.Cells["idGastosVarios"].Value.ToString();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (tabla.SelectedRows.Count > 0)
            {
                ...
                {
                    objeto.Eliminar(idGastosVarios);
        ...
        private void btnAceptarReportes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (txtDescripcionReporte.Text != "")
                {
                    ...
                    tablaReportes.DataSource = objetoMostrar.ReporteGastosVariosPorDescripcion(txtDescripcionReporte.Text);
                ...
                else if (txtFechaInicio.CustomFormat != " " && txtFechaFinal.CustomFormat != " ")
                {
                    ...
                    tabla.DataSource = objetoMostrar.BuscarGastosVariosPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);

                    tablaReportes.DataSource = objetoMostrar.ReporteGastosVariosPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);
