...
{
    public partial class GastosAdministrativos : Form
    {
        PB_GastosAdministrativos objeto = new PB_GastosAdministrativos();
        private bool Editar = false;
        string idGastosAdministrativos = null;
        ...
        private void GastosAdministrativos_Load(object sender, EventArgs e)
        {
            Mostrar();
        ...
        {
            PB_GastosAdministrativos objetoMostrar = new PB_GastosAdministrativos();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (Editar == true)
            {
                ...
                try
                {
                    ...
                    {
                        objeto.Actualizar(idGastosAdministrativos, txtDescripcion.Text, txtFecha.Value, txtMonto.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (tabla.SelectedRows.Count > 0)
            {
                ...
                idGastosAdministrativos = tabla.CurrentRow.Cells["idGastosAdministrativos"].Value.ToString();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (tabla.SelectedRows.Count > 0)
            {
                ...
                {
                    objeto.Eliminar(idGastosAdministrativos);
        ...
        private void btnAceptarReportes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (txtDescripcionReporte.Text != "")
                {
                    ...
                    tablaReportes.DataSource = objetoMostrar.ReporteGastosAdministrativosPorDescripcion(txtDescripcionReporte.Text);
                ...
                else if (txtFechaInicio.CustomFormat != " " && txtFechaFinal.CustomFormat != " ")
                {
                    ...
                    tabla.DataSource = objetoMostrar.BuscarGastosAdministrativosPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);

                    tablaReportes.DataSource = objetoMostrar.ReporteGastosAdministrativosPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);
