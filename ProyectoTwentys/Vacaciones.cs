...
namespace ProyectoTwentys
{
    ...
    {
        PB_Vacaciones objeto = new PB_Vacaciones();
        private bool Editar = false;
        string idEmpleado = null;
        string idVacaciones = null;
        ...
        {
            PB_Vacaciones objetoMostrar = new PB_Vacaciones();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            if (Editar == false)
            {
                try
                {
                    ...
                    {
                        objeto.Insertar(txtIDEmpleado.Text, txtFecha.Text, txtCantidadHoras.Text);
            ...
            if (Editar == true)
            {
                ...
                try
                {
                    ...
                    {
                        objeto.Actualizar(idVacaciones, txtIDEmpleado.Text, txtFecha.Value, txtCantidadHoras.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (tablaIngresoInformacion.SelectedRows.Count > 0)
            {
                ...
                idVacaciones = tablaIngresoInformacion.CurrentRow.Cells["idVacaciones"].Value.ToString();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (tablaIngresoInformacion.SelectedRows.Count > 0)
            {
                ...
                {
                    objeto.Eliminar(idEmpleado, idVacaciones);
        ...
        private void btnAceptarReportes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (txtIDEmpleadoReporte.Text != "")
                {
                    ...
                    tablaReportes.DataSource = objetoMostrar.ReporteVacacionesPorEmpleado(idEmpleado);
                ...
                else if (txtFechaInicio.CustomFormat != " " && txtFechaFinal.CustomFormat != " ")
                {
                    ...
                    tablaIngresoInformacion.DataSource = objetoMostrar.BuscarVacacionesPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);

                    tablaReportes.DataSource = objetoMostrar.ReporteVacacionesPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);
        ...
        private bool validarCamposVacios()
        {
            ...
            if (txtIDEmpleado.Text == "" |  txtFecha.Text == "" | txtCantidadHoras.Text == "")
            {
                datosVacios = true;
            }
