...
{
    public partial class SobrantesYFaltantes : Form
    {
        PB_SobrantesYFaltantes objeto = new PB_SobrantesYFaltantes();
        private bool Editar = false;
        string idEmpleado = null;
        string idSobrantesYFaltantes = null;


        public SobrantesYFaltantes()
        {
            InitializeComponent();
        }

        private void SobrantesYFaltantes_Load(object sender, EventArgs e)
        {
            Mostrar();
        ...
        {
            PB_SobrantesYFaltantes objetoMostrar = new PB_SobrantesYFaltantes();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            if (Editar == false)
            {
                try
                {
                    ...
                    {
                        objeto.Insertar(txtIDEmpleado.Text,  txtFecha.Text, txtMonto.Text, txtTipo.Text);
            ...
            if (Editar == true)
            {
                ...
                try
                {
                    ...
                    {
                        objeto.Actualizar(idSobrantesYFaltantes, txtIDEmpleado.Text, txtFecha.Value, txtMonto.Text, txtTipo.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (tablaIngresoInformacion.SelectedRows.Count > 0)
            {
                ...
                idSobrantesYFaltantes = tablaIngresoInformacion.CurrentRow.Cells["idSobrantesYFaltantes"].Value.ToString();
                txtIDEmpleado.Text = tablaIngresoInformacion.CurrentRow.Cells["idEmpleado"].Value.ToString();
                txtTipo.Text = tablaIngresoInformacion.CurrentRow.Cells["tipo"].Value.ToString();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (tablaIngresoInformacion.SelectedRows.Count > 0)
            {
                ...
                {
                    objeto.Eliminar(idEmpleado, idSobrantesYFaltantes);
        ...
        private void btnAceptarReportes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (txtIDEmpleadoReporte.Text != "")
                {
                    ...
                    tablaReportes.DataSource = objetoMostrar.ReporteSobrantesYFaltantesPorEmpleado(idEmpleado);
                ...
                else if (txtFechaInicio.CustomFormat != " " && txtFechaFinal.CustomFormat != " ")
                {
                    ...
                    tablaIngresoInformacion.DataSource = objetoMostrar.BuscarSobrantesYFaltantesPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);

                    tablaReportes.DataSource = objetoMostrar.ReporteSobrantesYFaltantesPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);
        ...
        private bool validarCamposVacios()
        {
            ...
            if (txtIDEmpleado.Text == "" | txtTipo.Text == "" | txtFecha.Text == "" | txtMonto.Text == "")
            {
                datosVacios = true;
            }
