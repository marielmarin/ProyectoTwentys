...
namespace ProyectoTwentys
{
    ...
    {
        PB_Viaticos objeto = new PB_Viaticos();
        private bool Editar = false;
        string idEmpleado = null;
        string idViatico = null;
        ...
        {
            PB_Viaticos objetoMostrar = new PB_Viaticos();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (Editar == true)
            {
                ...
                try
                {
                    ...
                    {
                        objeto.Actualizar(idViatico, txtIDEmpleado.Text, txtDescripcion.Text, txtFecha.Value, txtMonto.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (tablaIngresoInformacion.SelectedRows.Count > 0)
            {
                ...
                idViatico = tablaIngresoInformacion.CurrentRow.Cells["idViatico"].Value.ToString();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (tablaIngresoInformacion.SelectedRows.Count > 0)
            {
                ...
                {
                    objeto.Eliminar(idEmpleado, idViatico);
        ...
        private void btnAceptarReportes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (txtIDEmpleadoReporte.Text != "")
                {
                    ...
                    tablaReportes.DataSource = objetoMostrar.ReporteViaticosPorEmpleado(idEmpleado);
                ...
                else if (txtFechaInicio.CustomFormat != " " && txtFechaFinal.CustomFormat != " ")
                {
                    ...
                    tablaIngresoInformacion.DataSource = objetoMostrar.BuscarViaticosPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);

                    tablaReportes.DataSource = objetoMostrar.ReporteViaticosPorFecha(txtFechaInicio.Text, txtFechaFinal.Text);
